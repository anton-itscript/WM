...
<div class="middlewide">
    ...
    <h1>
        <a href="<?php echo $this->createUrl('admin/StationTypeDataExport') ?>"> Station Type Report Generation </a> /
        <a href="<?php echo $this->createUrl('admin/StationTypeDataHistory',array('ex_schedule_id'=>$report->ex_schedule_id)) ?>">Report <?=$report->ex_schedule_id?>  </a> /
