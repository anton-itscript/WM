...
<div class="middlewide">
    <div class="middlenarrow">
        ...
        <?php echo CHtml::beginForm($this->createUrl('admin/StationTypeDataExport'), 'post'); ?>
        ...
        <table>
            <tr>
                <td>
                    ...
                    <?php echo CHtml::button(It::t('site_label', 'do_cancel'), array('onclick' => 'document.location.href="'.$this->createUrl('admin/StationTypeDataExport').'"')); ?>
                </td>
            </tr>
        </table>
        ...
        <table class="tablelist schedulelist">
            ...
            <?php foreach ($scheduleTypesReports['result'] as $item) {?>
                <tr <?php echo  $item->active ? 'class="enabled"' : 'class="disabled"'?>>
                    <td  class="cell-vm-ac">
                        <a href="<?php echo $this->createUrl('admin/StationTypeDataExport', array('ex_schedule_id' => $item->ex_schedule_id)); ?>"><?=$item->ex_schedule_id?></a>
                    </td>
                    <td>
                        <ul>
                    ...
                    <td  class="cell-vm-al">
                        ...
                        <a href="<?php echo $this->createUrl('admin/StationTypeDataExport', array('ex_schedule_id' => $item->ex_schedule_id)); ?>">Edit</a>
                        <div class="spacer"></div>
                        <a href="<?php echo $this->createUrl('admin/StationTypeDataExport', array('ex_schedule_id' => $item->ex_schedule_id, 'active'=> $item->active ? 0 : 1)); ?>"><?php echo  $item->active ? 'Enabled' : 'Disabled'?></a>
                        <div class="spacer"></div>
                        <a href="<?php echo $this->createUrl('admin/StationTypeDataHistory', array('ex_schedule_id' => $item->ex_schedule_id)); ?>"><?php echo It::t('site_label', 'do_history'); ?></a>
                        <div class="spacer"></div>
                        <a href="<?php echo $this->createUrl('admin/StationTypeDataExport', array('ex_delete_id' => $item->ex_schedule_id)); ?>" onclick="return confirm('Are you sure you want to delete schedule?')"><?php echo It::t('site_label', 'do_delete'); ?></a>
                        <div class="spacer"></div>
